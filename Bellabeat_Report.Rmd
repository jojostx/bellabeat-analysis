---
title: "BellaBeat Analysis: Converting Casual Riders to Members"
...
- **Analysis Outputs**: Multiple CSV files in `data/processed/` directory
...
**Total Rides Analyzed**: See data/processed/member_stats.csv for complete statistics
